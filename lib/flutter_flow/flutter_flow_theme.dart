...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF8F1C);
  ...
  late Color accent1 = const Color(0xFFFF4D00);
  late Color accent2 = const Color(0xFFFFB74D);
  late Color accent3 = const Color(0xFFFFAA1C);
  late Color accent4 = const Color(0xFFFFC266);
